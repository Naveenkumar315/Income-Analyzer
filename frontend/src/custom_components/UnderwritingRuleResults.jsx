            ...
            <div className="h-[100px] mt-3 w-full relative rounded-2xl overflow-hidden shadow">
              ...
              <div className="relative grid grid-cols-4 gap-4 h-full p-5">
                <div className="flex flex-col p-2 gap-1 pl-5 bg-white rounded-2xl">
                  <span className="text-black font-bold pl-1">{report?.rules?.rule_result?.Pass}</span>
                  <span className="flex items-center gap-1 text-sm">
                ...
                <div className="flex flex-col p-2 gap-1 pl-5 bg-white rounded-2xl">
                  <span className="text-black font-bold pl-1">{report?.rules?.rule_result?.Fail}</span>
                  <span className="flex items-center gap-1 text-sm">
                ...
                <div className="flex flex-col p-2 gap-1 pl-5 bg-white rounded-2xl">
                  <span className="text-black font-bold pl-1">{report?.rules?.["rule_result"]?.["Insufficient data"]}</span>
                  <span className="flex items-center gap-1 text-sm">
                ...
                <div className="flex flex-col p-2 gap-1 pl-5 bg-white rounded-2xl">
                  <span className="text-black font-bold pl-1">{report?.rules?.rule_result?.["Error"]}</span>
                  <span className="flex items-center gap-1 text-sm">
                    <CheckCircleIcon className="text-green-500 text-base" />
                    Error
                  </span>
