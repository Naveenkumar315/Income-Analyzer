              ...
              <div className="relative h-[100px] mt-3 w-full rounded-2xl overflow-hidden shadow">
                ...
                <div className="relative p-5 h-full">
                  <div className="grid grid-cols-5 gap-4 h-full">
                      ...
                      <span className="text-black font-bold pl-1">
                        $
                        {
                          report?.["income_summary"]?.[
                            "current_year_gross_monthly_salary"
                          ]
                        }
                      </span>
                    ...
                    <div className="flex flex-col p-2 gap-1 pl-5 bg-white rounded-2xl shadow">
                      <span className="text-black font-bold pl-1">
                        ${report?.["income_summary"]?.["current_year_bonus"]}
                      </span>
                      <span className="flex items-center gap-1 text-sm">
                        Bonus
                      </span>
                    ...
                    <div className="flex flex-col p-2 gap-1 pl-5 bg-white rounded-2xl shadow">
                      <span className="text-black font-bold pl-1">
                        ${report?.["income_summary"]?.["current_year_overtime"]}
                      </span>
                      <span className="flex items-center gap-1 text-sm">
                        Overtime
                      </span>
